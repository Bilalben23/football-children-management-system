                    ...
                    <div class="grid gap-8 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-3">
                        @forelse($children as $child)
                            <a href="{{ route('children.show', $child->id) }}"
                                class="flex items-center p-6 space-x-6 transition bg-[#1A2130] border-2 border-transparent rounded-lg shadow-lg hover:opacity-95 hover:border-[#E88D67] hover:shadow-2xl">
